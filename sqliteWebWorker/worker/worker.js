// Web Worker implementing the WebWorkerSQLiteDriver communication protocol on top of SQLite-WASM,
// persisting to the Origin Private File System (OPFS). Mirrors the reference worker from
// androidx's room-web sample. Bundled by webpack via `new Worker(new URL("quits-sqlite-worker/worker.js", import.meta.url))`.
